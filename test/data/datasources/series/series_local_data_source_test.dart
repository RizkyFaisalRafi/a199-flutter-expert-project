...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success',
        () async {
      // arrange
      when(mockDatabaseHelper.insertSeriesWatchlist(testSeriesTable))
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success',
        () async {
      // arrange
      when(mockDatabaseHelper.removeSeriesWatchlist(testSeriesTable))
          .thenAnswer((_) async => 1);
      // act
      final result = await dataSource.removeSeriesWatchlist(testSeriesTable);
      // assert
    ...
    test('should throw DatabaseException when remove from database is failed',
      ...
      when(mockDatabaseHelper.removeSeriesWatchlist(testSeriesTable))
          .thenThrow(Exception());
      // act
      final call = dataSource.removeSeriesWatchlist(testSeriesTable);
      // assert
      expect(() => call, throwsA(isA<DatabaseException>()));
    });
  });
